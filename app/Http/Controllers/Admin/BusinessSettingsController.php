...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'successfully updated to changes restart app',
        );
        return back()->with($notifikasi);
    }
    ...
    public function mail_config(Request $request)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'configuration updated successfully',
        );
        return back()->with($notifikasi);
    }
    ...
    public function update_landing_page_settings(Request $request, $tab)
    {
        ...
        if ($tab == 'text') {
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page text updated',
            );
        } else if ($tab == 'links') {
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page links updated',
            );
        } else if ($tab == 'speciality') {
            $data = [];
            $imageName = null;
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page speciality updated',
            );
        } else if ($tab == 'feature') {
            $data = [];
            $imageName = null;
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page feature updated',
            );
        } else if ($tab == 'testimonial') {
            $data = [];
            $imageName = null;
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page testimonial updated',
            );
        } else if ($tab == 'image') {
            $data = [];
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'landing page image updated',
            );
        } else if ($tab == 'background-change') {
            ...
            $notifikasi = array(
                'alert' => 'success',
                'pesan' => 'web app landing page settings',
            );
        }
        return back()->with($notifikasi);
    }
    ...
    public function currency_store(Request $request)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'currency added successfully',
        );
        return back()->with($notifikasi);
    }
    ...
    public function currency_update(Request $request, $id)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'currency updated successfully',
        );
        return redirect('vendor-panel/business-settings/currency-add')->with($notifikasi);
    }
    ...
    public function currency_delete($id)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'currency deleted successfully',
        );
        return back()->with($notifikasi);
    }
    ...
    public function terms_and_conditions_update(Request $request)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'terms and condition updated',
        );
        return back()->with($notifikasi);
    }
    ...
    public function location_setup(Request $request)
    {
        ...
        $notifikasi = array(
            'alert' => 'success',
            'pesan' => 'message settings updated',
        );
        return back()->with($notifikasi);
    }
