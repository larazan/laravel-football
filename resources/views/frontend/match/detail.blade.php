...
<div class="mx-auto w-full lg:w-1/2">
        <img src="{{ url('assets/img/lineup.png') }}" alt="" />
      </div>

      <div class="flex flex-col md:px-4 py-2 space-y-2 bg-blue-900 ">
        <div class="flex mx-auto w-11/12 md:w-10/12 items-center space-x-6">
          <div class="flex w-1/2 justify-end">
            <span class="text-xs font-semibold text-gray-300">
              Wed, 26/07/23, 17:30 GMT+7
            </span>
          </div>
          <div class="flex w-1/2 justify-end md:justify-start">
            <span class="text-xs font-semibold text-gray-300">
        ...
        <div class="flex flex-col">
          <div class="flex w-full h-full py-1.5">
            <div class="flex flex-col mx-auto w-11/12 md:w-10/12  items-center">
              <div class="flex w-full items-center space-x-1">
                <div class="w-5/12 flex items-center space-x-2 justify-end">
                  <div>
                ...
                <div class="w-2/12 flex space-x-2 items-center justify-center">
                  <div>
                    <span class="text-lg text-white font-bold">1</span>
                  </div>
                  <span class="text-lg text-white font-bold">:</span>
                  <div>
                    <span class="text-lg text-white font-bold">2</span>
                  </div>
                </div>
                <div class="w-5/12  flex items-center space-x-2 justify-start">
                  <div class="w-8">
                    <img src="{{ url('assets/img/clubs/manchester-city.png') }}" alt="" />
                  </div>
                  <div class="flex items-end text-right md:text-right">
                    <span class="text-sm font-bold text-white">
                      Manchester City
                    </span>
                  </div>
              ...
              <div class="flex w-full items-center2 space-x-8">
                <div class="w-1/2 flex justify-end">
                  <ul>
                    <li>
                      <div class="flex space-x-2 items-center">
                        <div>
                          <span class="text-white text-xs">Mathys Tel</span>
                        </div>
                        <div>
                        ...
                        <div class="bg-white rounded-full text-slate-800 shadow-md">
                          <svg
                            height="16"
                            width="16"
                            viewBox="0 0 24 24"
      ...
      <div class="flex px-3 md:px-6 py-4 mx-auto w-full lg:w-1/2 bg-white">
