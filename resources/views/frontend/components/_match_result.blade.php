                            ...
                            <li>
                                <div className="flex space-x-2 items-center">
                                    ...
                                    <div className="bg-white rounded-full text-slate-800 shadow-md">
                                        <svg height="16" width="16" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" role="img" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" className="base-icon__StyledIconSvg-sc-fzrbhv-0 eCHnXp">
                                            <title>icon</title>
