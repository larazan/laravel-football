...
<div class="h-max flex flex-col py-0 md:py-6  bg-[#f5f7f9]" bis_skin_checked="1">
    <div class="mx-auto w-full lg:w-1/2" bis_skin_checked="1"><img alt="" loading="lazy" width="1200" height="600" decoding="async" data-nimg="1" srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmuller_training.e6df6b7e.png&amp;w=1200&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmuller_training.e6df6b7e.png&amp;w=3840&amp;q=75 2x" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmuller_training.e6df6b7e.png&amp;w=3840&amp;q=75" style="color: transparent;"></div>
</div>

<div class="h-max flex flex-col py-0 md:py-6  bg-[#f5f7f9]" bis_skin_checked="1">
    <div class="flex flex-col space-y-3 mx-auto w-11/12 md:w-8/12 lg:w-1/2 justify-center" bis_skin_checked="1">
        <div class="flex pt-3 flex-row justify-between md:justify-normal space-x-3" bis_skin_checked="1">
            <div bis_skin_checked="1"><span class="text-sm font-semibold text-[#dc052d]">Individual Training</span></div>
            <div bis_skin_checked="1"><span class="text-xs md:text-sm font-semibold text-gray-400">Fri, 21/07/23, 20:45 GMT+7</span></div>
        </div>
        <div bis_skin_checked="1">
            <h1 class="text-2xl leading-tight font-bold text-[#002f6c]">Thomas Muller to stay in Munich</h1>
        </div>
        <div class="md:py-6 pb-6 text-gray-800" bis_skin_checked="1">
    ...
    <div class="flex flex-row py-4 md:py-6 border-y" bis_skin_checked="1">
        <div class="flex flex-col space-y-3 md:space-y-0 md:flex-row mx-auto w-11/12 md:w-8/12 lg:w-1/2" bis_skin_checked="1">
            <div class="flex flex-col w-full md:w-1/2 " bis_skin_checked="1">
                <div bis_skin_checked="1"><span class="text-sm font-semibold text-gray-400">Topics of this article</span></div>
                <div bis_skin_checked="1">
                    <div class="flex flex-wrap " bis_skin_checked="1"><button class="flex mr-2 mt-2 rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200"><span class=" font-semibold text-[#002f6c] text-sm">News</span></button><button class="flex mr-2 mt-2 rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200"><span class=" font-semibold text-[#002f6c] text-sm">Thomas Muller</span></button><button class="flex mr-2 mt-2 rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200"><span class=" font-semibold text-[#002f6c] text-sm">Training</span></button><button class="flex mr-2 mt-2 rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200"><span class=" font-semibold text-[#002f6c] text-sm">Audi Summer Tour 2023</span></button></div>
                </div>
            </div>
            <div class="flex flex-col w-1/2 space-y-3" bis_skin_checked="1">
                <div bis_skin_checked="1"><span class="text-sm font-semibold text-gray-400">Share this article</span></div>
                <div class="flex space-x-4 OuQGd" bis_skin_checked="1"><a class="" href="/"><span class="text-[#002f6c]"><svg height="28" width="28" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" role="img" xmlns="http://www.w3.org/2000/svg" class="base-icon__StyledIconSvg-sc-fzrbhv-0 eCHnXp">
                                <title>icon</title>
...
<div class="h-max flex flex-col space-y-3 px-0 md:px-6 py-4 md:py-4 justify-center2 items-center2 bg-[#f5f7f9]" bis_skin_checked="1">
    <div class="mx-auto w-12/12 md:w-12/12 lg:w-1/2" bis_skin_checked="1">
        <div class="flex flex-row justify-between mx-auto md:mx-0 w-11/12 md:w-12/12 lg:w-1/2 space-x-6 items-center" bis_skin_checked="1"><a class="flex space-x-1 items-center hover:opacity-80" href="/"><span class="text-lg md:text-2xl font-bold text-[#002f6c] uppercase">Related News</span></a></div>
        <div class="flex flex-row flex-wrap  mx-auto w-full md:w-12/12 " bis_skin_checked="1">
            <div class="px-3 py-3 w-1/2 md:w-1/3 lg:w-1/3" bis_skin_checked="1">
                <div class=" bg-white group flex flex-col overflow-hidden hover:scale-105 shadow " bis_skin_checked="1"><a class="relative" href="/news/one"><img alt="" loading="lazy" width="520" height="293" decoding="async" data-nimg="1" class="w-full" srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffans1.b55b6a25.png&amp;w=640&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffans1.b55b6a25.png&amp;w=1080&amp;q=75 2x" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffans1.b55b6a25.png&amp;w=1080&amp;q=75" style="color: transparent;">
                    ...
                    <div class="px-3 py-2 pb-4 flex flex-col space-y-1 leading-tight" bis_skin_checked="1">
                        <div class="font-semibold text-xs md:text-xs uppercase text-red-500" bis_skin_checked="1">Membership</div><a href="/news/one"><span class="font-semibold text-base md:text-md text-[#002f6c] leading-tight">Become part of the FC Bayern family!</span></a>
                    </div>
                </div>
            </div>
            <div class="px-3 py-3 w-1/2 md:w-1/3 lg:w-1/3" bis_skin_checked="1">
