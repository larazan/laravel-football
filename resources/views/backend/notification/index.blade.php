                ...
                <tbody>
                  <tr class="bg-white text-gray-800 border border-gray-300 font-bold ">
                    ...
                    <td class="flex justify-center text-sm text-center p-4">
                      <Link
                        href={"/"}
                        class="flex justify-center items-center h-5 w-5 md:h-6 md:w-6 rounded-full bg-white hover:bg-black text-black hover:text-white border shadow border-black"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
