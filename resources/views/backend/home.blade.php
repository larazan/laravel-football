...
<main class="bg-white bg-opacity-252 min-h-screen">
  ...
  <div class="py-3 mx-auto w-11/12 ">
    <div class="flex w-full flex-col space-y-2">
      <div class="pt-5">
        <span class="text-lg font-bold tracking-tight capitalize text-gray-800">
          Account Details
        </span>
      </div>
      <div class="flex w-full">
        <div class="w-32">
          <span class="text-gray-800 tracking-tighter font-semibold">
            Name
          </span>
        </div>
        <div class="">
          ...
          <tbody>
            <tr class="bg-white text-gray-800 border border-gray-300 font-bold ">
              <td class="text-sm p-4 uppercase text-gray-600">
                <a href="{{ url('account/orders/1') }}" class='flex justify-center p-1.5 border border-gray-300 bg-gray-50 hover:bg-gray-200 cursor-pointer'>#1001</a>
              </td>
              ...
              <td class="text-sm text-center p-4 uppercase">
                <p>$200.00 CAD</p>
              </td>
            </tr>
            <tr class="bg-white text-gray-800 border border-gray-300 font-bold">
