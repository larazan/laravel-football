<div class="relative inline-flex" x-data="{ open: false }">
        ...
        <div
          class="origin-top-right z-30 absolute top-full shadow-menu2 right-0 -mr-2 md:-mr-2 sm:mr-0 min-w-52 w-48 bg-white rounded border border-slate-300 py-1.5  shadow-lg overflow-hidden mt-1.5 md:mt-1.5"
        ...
        >
          <div>
            ...
            <ul>
              ...
              <li class="border-b last:border-0">
                <div class="flex w-full items-center space-x-2 py-1.5 px-4 ">
