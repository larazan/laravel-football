<div
        class="hidden flex2 flex-col w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] transition-all duration-300 z-50 px-4 lg:px-[35px]"
        id="menubar"
        :class="filterOpen ? 'left-0' : '-left-full'" 
      ...
      >
        <div class="flex w-full items-center justify-between py-4 border-b">
          ...
          <div class="flex justify-end w-1/2">
            <div
              ...
              class="cursor-pointer w-8 h-8 flex justify-center items-center rounded-full bg-pink-200 hover:bg-pink-300"
            >
              <svg
        ...
        <div class="divide-y">
                ...
                <div>
                  <div>
                    <div class="mb-3 flex items-center justify-between text-sm">
                      Between €0 and €300
                      <button
                        class="cursor-pointer inline-block leading-none select-none text-center focus:outline-none transition-colors disabled:cursor-not-allowed max-h-10 relative p-0 text-sm text-primary transition-all hover:underline invisible opacity-0"
                        type="button"
                        data-variant="null_null"
                      ></button>
                    </div>
                    <div
                      class="relative my-6 flex h-auto w-full px-2"
                      style=" transform: scale(1); cursor: inherit "
                    >
                      <div
                        class="h-[1px] w-full self-center before:absolute before:left-0 before:h-[1px] before:w-2 before:bg-[#707070] after:absolute after:right-0 after:h-[1px] after:w-2 after:bg-[#707070]"
                        style=" background:linear-gradient(to right, #707070 0%, #707070 0%, #debe48 0%, #debe48 100%, #707070 100%, #707070 100%);"
                      >
                        <div
                          style="
                            position: absolute;
                          ...
                          draggable="false"
                          role="slider"
                          class="flex h-4 w-4 items-center justify-center rounded-full bg-primary outline-none transition-shadow"
                        >
          ...
          <div>
            {{--  <div
            class="bg-[#073d30] hover:opacity-80 uppercase  rounded text-white border border-[#073d30] flex p-3 justify-center items-center w-full font-semibold cursor-pointer"
          >
            Filter
          </div> --}}
          </div>
        ...
        <div class="hidden opacity-50 fixed inset-0 z-30 bg-black"></div>