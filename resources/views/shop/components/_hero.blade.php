...
<div class="px-2 bg-white text-slate-900 text-center max-w-[800px] mx-auto my-[20px] md:my-[80px]">
  ...
  <div class="text-md md:text-xl leading-tight">
        ...
        <section class="mx-auto w-10/12 flex justify-center flex-wrap gap-9">
          <div class="bg-white flex-1 sm:w-[350px] sm:min-w-[350px] w-full border rounded-[20px] shadow-3xl px-10 py-16">
            <div class="w-11 h-11 flex justify-center items-center bg-orange-500 rounded-full">
              <image
                src="{{ asset('assets/img/icons/truck-fast.svg') }}"
alt="Free shipping"
width="24"
height="24"
/>
...
<div class="bg-white flex-1 sm:w-[350px] sm:min-w-[350px] w-full border rounded-[20px] shadow-3xl px-10 py-16">
  <div class="w-11 h-11 flex justify-center items-center bg-orange-500 rounded-full">
    <image src="{{ asset('assets/img/icons/shield-tick.svg') }}" alt="Secure Payment" width="24" height="24" />
  </div>
  <h3 class="mt-5 font-palanquin text-3xl leading-normal font-bold">
    Secure Payment
  </h3>
...
<div class="bg-white flex-1 sm:w-[350px] sm:min-w-[350px] w-full border rounded-[20px] shadow-3xl px-10 py-16">
  <div class="w-11 h-11 flex justify-center items-center bg-orange-500 rounded-full">
    <image src="{{ asset('assets/img/icons/support.svg') }}" alt="Love to help you" width="24" height="24" />
  </div>
  <h3 class="mt-5 font-palanquin text-3xl leading-normal font-bold">
    Love to help you
  </h3>
