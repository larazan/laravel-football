...
<!-- @dump(json_encode($subCategory)) -->
  ...
  <div x-data="dropdown()" x-init="loadData()" class="w-full md:w-1/2 flex flex-col items-center h-full mx-auto">
          ...
          <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
            <div class="flex flex-auto flex-wrap">
              <template x-for="(option,index) in selected" :key="options[option].value">
                <div class="flex justify-center items-center m-1 font-medium py-1 px-1 bg-white rounded bg-gray-1002 border">
  ...
  function dropdown() {
    return {
      ...
      loadData() {
        ...
        // this.options = JSON.parse($subCategory) ? JSON.parse($subCategory) : []
