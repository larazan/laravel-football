                    ...
                    <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
                        <div class="flex flex-auto flex-wrap">
                            <template x-for="(option,index) in selected" :key="option[trackBy]">
                                <div class="flex justify-center items-center m-1 font-medium py-1 px-1 space-x-1 bg-white2 rounded bg-gray-100 border">
                                    <div 
                            ...
                            <div x-show="selected.length == 0" class="flex-1">
                                <input placeholder="{{$attributes->get('placeholder') ?: 'Select Option'}}"
                                       class="bg-transparent p-1 px-2 appearance-none border-none outline-none h-full w-full text-gray-800"
                                >
                            </div>
                        </div>
                        <div class="text-gray-300 w-8 py-1 pl-2 pr-1 flex items-center border-l border-gray-200">
    ...
    <script>
        function dropdown() {
            return {
                ...
                // selected: [{ 'id': 8, 'name': 'LB'},{ 'id': 6, 'name': 'RB'}], must json format
