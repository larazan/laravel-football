...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Team League ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Team League</span>
            </button>
        </div>
    ...
    <x-jet-dialog-modal wire:model="showTeamModal" class="">

        @if ($teamId)
        <x-slot name="title" class="border-b">Update Team</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Team</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    ...
                    @else
                    <x-m-button wire:click="createTeamLeague" class=" ho xi ye2">Create</x-m-button>
                    @endif
                </div>
            </div>
