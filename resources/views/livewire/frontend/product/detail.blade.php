    ...
    <div class="w-full max-w-[1280px] px-4 md:px-6 mx-auto">
        <div class="flex flex-col md:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
            ...
            <div class="flex-[1] py-3 md:py-0">
                ...
                <button wire:click="addToWishlist({{ $product->id }})" class="w-full py-2 md:py-3 rounded border-2 bg-[#3bd6ff] border-[#3bd6ff] text-slate-900 hover:text-[#3bd6ff] text-base md:text-lg font-medium transition-transform active:scale-95 flex items-center justify-center gap-2 hover:bg-white mb-10 uppercase tracking-tight2">
