...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Product Slider ✨</h1>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Product Sliders <span class="gq gp"></span></h2>
        </header>
            ...
            <div class="lf">
                <table class="ux ou">
                    ...
                    <tbody class="text-sm le lr" wire:sortable="updateTaskOrder">
                        <!-- Row -->
                        <tr wire:sortable.item="1" wire:key="task-1">
                            ...
                            <td class="vi wy w_ vo lm of" wire:sortable.handle>
    ...
    <x-dialog-modal wire:model="showProductSlideModal" class="">

        @if ($slideId)
        <x-slot name="title" class="border-b">Update Product Slider</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Product Slider</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeProductSlideModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($slideId)
                    <x-button wire:click="updateProductSlide" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createProductSlide" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
