<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Coupon ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Coupon</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Coupons <span class="gq gp"></span></h2>
        </header>
                ...
                <table class="ux ou">
                    ...
                    <thead class="go gh gv text-slate-500 hp co cs border-slate-200">
                        <tr>
                            ...
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Expire</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Discount</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $coupon->title }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $coupon->code }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $coupon->start_date }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $coupon->expire_date }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $coupon->discount }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm">
                                ...
                                <div class="inline-flex gp hf yl rounded-full gn vp vd">{{ $coupon->status }}</div>
                                @endif

                                @if ($coupon->status === 'active')
                                <div class="inline-flex gp hc ys rounded-full gn vp vd">{{ $coupon->status }}</div>
                                @endif
                            </td>
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $coupon->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $coupon->id }})">
    ...
    <x-dialog-modal wire:model="showCouponModal" class="">

        @if ($couponId)
        <x-slot name="title" class="border-b">Update Coupon</x-slot>
        @else
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="flex flex-row justify-between">
                                            <div class="col-start-1 sm:col-span-3">
                                                ...
                                                <x-flatpicker wire:model="startDate"></x-flatpicker>
                                            </div>
                                            <div class="col-start-1 sm:col-span-3">
                                                <label for="title" class="block text-sm font-medium text-gray-700">
                                                    Expire Date
                                                </label>
                                                <x-flatpicker wire:model="expireDate"></x-flatpicker>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-row justify-between">
                                            ...
                                            <div class="col-start-1 sm:col-span-3">
                                                ...
                                                <input wire:model="discount" type="number" step="0.01" min="1" max="999999999999.99" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                            </div>
                                            <div class="col-start-1 sm:col-span-3">
                                                <label for="title" class="block text-sm font-medium text-gray-700">
                                                    Max Discount
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select wire:model="couponStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
                                                <option value="">Select Option</option>
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeCouponModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($couponId)
                    <x-button wire:click="updateCoupon" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createCoupon" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
