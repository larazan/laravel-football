...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Position</span>
            </button>
        </div>
                ...
                <table class="ux ou">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $position->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $position->id }})">
    ...
    <x-dialog-modal wire:model="showPositionModal" class="">

        @if ($positionId)
        <x-slot name="title" class="border-b">Update Position</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Position</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closePositionModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($positionId)
                    <x-button wire:click="updatePosition" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createPosition" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
