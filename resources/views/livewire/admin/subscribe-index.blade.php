...
<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Subscriber ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Subscriber</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Newsletter Subscriber<span class="gq gp"></span></h2>
        </header>
    ...
    <x-dialog-modal wire:model="showSubscriberModal" class="">
        ...
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Subscriber</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeNewsletterSubscriberModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($newsletterSubscriberId)
                    <x-button wire:click="updateNewsletterSubscriber" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createNewsletterSubscriber" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
