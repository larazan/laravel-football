...
<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold"> Slider</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Slider</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Sliders <span class="gq gp"></span></h2>
        </header>
        <div x-data="handleSelect">
            ...
            <div class="lf">
                <table class="ux ou">
                    ...
                    <!-- Table body -->
                    <tbody class="text-sm le lr" wire:sortable="updateTaskOrder">
                        <!-- Row -->
                        <tr>
                        ...
                        <tr wire:sortable.item="{{ $slide->id }}" wire:key="slide-{{ $slide->id }}" wire:sortable.handle>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $slide->title }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                                <img src="{{ asset('storage/'.$slide->small) }}" class="object-scale-down h-48 w-96" alt="{{ $slide->title }}">
                                </div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $slide->id }})">
                                    <span class=" d">Edit</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M19.7 8.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM12.6 22H10v-2.6l6-6 2.6 2.6-6 6zm7.4-7.4L17.4 12l1.6-1.6 2.6 2.6-1.6 1.6z"></path>
                                        </svg>
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $slide->id }})">
                                    <span class=" d">Delete</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M13 15h2v6h-2zM17 15h2v6h-2z"></path>
                                            <path d="M20 9c0-.6-.4-1-1-1h-6c-.6 0-1 .4-1 1v2H8v2h1v10c0 .6.4 1 1 1h12c.6 0 1-.4 1-1V13h1v-2h-4V9zm-6 1h4v1h-4v-1zm7 3v9H11v-9h10z"></path>
    ...
    <x-dialog-modal wire:model="showSlideModal" class="">

        @if ($slideId)
        <x-slot name="title" class="border-b">Update Slide</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Slide</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-start-1 sm:col-span-3">
                                            ...
                                            <select wire:model="slideStatus" class="h-full2 rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none capitalize">
                                        ...
                                        <div class="col-start-1 sm:col-span-3">
                                            ...
                                            <select wire:model="category" class="h-full2 rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none capitalize">
                                                <option value="" >Select Option</option>
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeSlideModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($slideId)
                    <x-button wire:click="updateSlide" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createSlide" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
