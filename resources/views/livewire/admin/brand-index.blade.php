...
<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Brand</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Brands <span class="gq gp"></span></h2>
        </header>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $brand->name }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                                    @if ($brand->small)
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $brand->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $brand->id }})">
    ...
    <x-dialog-modal wire:model="showBrandModal" class="">

        @if ($brandId)
        <x-slot name="title" class="border-b">Update Brand</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Brand</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select wire:model="brandStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeBrandModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($brandId)
                    <x-button wire:click="updateBrand" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createBrand" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
