<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Session</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Training Sessions <span class="gq gp"></span></h2>
        </header>
                ...
                <table class="ux ou">
                    ...
                    <thead class="go gh gv text-slate-500 hp co cs border-slate-200">
                        <tr>
                            ...
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Training Type</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Focus</div>
                            </th>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $session->name }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $session->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $session->id }})">
    ...
    <x-dialog-modal wire:model="showSessionModal" class="">

        @if ($sessionId)
        <x-slot name="title" class="border-b">Update Session</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Training Session</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="focus" class="block text-sm font-medium text-gray-700">Name</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="focus" class="block text-sm font-medium text-gray-700">Focus</label>
                                            <textarea wire:model="focus" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="note" class="block text-sm font-medium text-gray-700">Note</label>
                                            <textarea wire:model="note" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeSessionModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($sessionId)
                    <x-button wire:click="updateSession" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createSession" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
