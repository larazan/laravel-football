<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Customers {{ $customerId }} ✨</h1>
        </div>

    </div>

    <div class="w-80 bg-white dark:bg-slate-800 mb-8 rounded-sm border border-slate-200 dark:border-slate-700 cugyv cv1va c4osb cetne">
        <div class="flex flex-col chmlm crszu">

            <!-- Card top -->
            <div class="border-b p-3 border-slate-200 dark:border-slate-700">
                <div class="flex justify-between">
                    <span class="text-base font-semibold uppercase">Ellen Reyna</span>
