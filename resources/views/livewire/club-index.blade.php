        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeClubModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($clubId)
                    <x-button wire:click="updateClub" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createClub" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
