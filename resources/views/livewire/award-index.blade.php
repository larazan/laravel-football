...
<x-loading-indicator />
    ...
    <x-jet-dialog-modal wire:model="showAwardModal" class="">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-m-button wire:click="closeAwardModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
                    @if ($awardId)
                    <x-m-button wire:click="updateAward" class=" ho xi ye">Update</x-m-button>
                    @else
                    <x-m-button wire:click="createAward" class=" ho xi ye2">Create</x-m-button>
                    @endif
                </div>
            </div>
