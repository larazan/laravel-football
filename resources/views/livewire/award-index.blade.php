...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Award ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Award</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Awards <span class="gq gp"></span></h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                                    ...
                                    <img src="{{ asset('storage/'.$award->troph->trophy) }}" class="object-scale-down w-20" alt="{{ $award->competition->name }}">
                                    @endif    
                                </div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                @if ($award->status === 'inactive')
                                    <div class="inline-flex gp hf yl rounded-full gn vp vd">{{ $award->status }}</div>
                                @endif 

                                @if ($award->status === 'active')
                                    <div class="inline-flex gp hc ys rounded-full gn vp vd">{{ $award->status }}</div>
                                @endif 
                            </td>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $award->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $award->id }})">
    ...
    <x-dialog-modal wire:model="showAwardModal" class="">
        ...
        @if ($awardId)
        <x-slot name="title" class="border-b">Update Award</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Award</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="photo" class="block text-sm font-medium text-gray-700">Competition</label>
                                                <select wire:model="competition" class="h-full2 rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select wire:model="awardStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeAwardModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($awardId)
                    <x-button wire:click="updateAward" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createAward" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
