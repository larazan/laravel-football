    ...
    <x-adminlte-modal id="createScheduleModal" title="予定登録" theme="info" v-centered scrollable wire:ignore.self>
        <div class="row">
            <div class="col-12" style="height:500px">
                <div class="row">
                    <x-adminlte-select name="schedule.user_id" label="ユーザー" fgroup-class="col-12" wire:model.defer="schedule.user_id">
                ...
                <div class="row">
                    <x-adminlte-input name="schedule.title" fgroup-class="col-12" label="タイトル" wire:model.defer="schedule.title" />
                </div>
                <div class="row">
                    <x-adminlte-input name="schedule.day" fgroup-class="col-12" class="flatpickrDay" label="日付" wire:model.lazy="schedule.day" />
                </div>
                <div class="row">
                    <x-adminlte-input name="schedule.start" label="開始時間" fgroup-class="col-6" class="flatpickrStartTime" wire:model.defer="schedule.start" />

                    <x-adminlte-input name="schedule.end" label="終了時間" fgroup-class="col-6" class="flatpickrEndTime" wire:model.defer="schedule.end" />
                </div>
            </div>
