...
use App\Http\Livewire\MatchGallery;
use App\Http\Livewire\MatchIndex;
use App\Http\Livewire\MatchLineup;
use App\Http\Livewire\MatchReport;
use App\Http\Livewire\MatchStatistic;
...
Route::middleware(['auth:sanctum', 'verified', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('match-gallery', MatchGallery::class)->name('match-gallery.index');
    Route::get('match-lineup', MatchLineup::class)->name('match-lineup.index');
    Route::get('match-report', MatchReport::class)->name('match-report.index');
    Route::get('match-statistic', MatchStatistic::class)->name('match-statistic.index');
